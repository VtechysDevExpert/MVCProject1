...
namespace eCommerce.Data
{
    public class eCommerceDBInitializer : CreateDatabaseIfNotExists<eCommerceContext>
    {
        ...
        public void SeedUsers(eCommerceContext context)
        {
           ...
           // admin.ZipCode = "123456";  we have separted the address fields into useraddress table instead of users table thats why this field are commented //01.09.2021 @asad
