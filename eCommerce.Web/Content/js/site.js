...
$(document).ready(function () {
    ...
    if (darkModeEnabled) {
        ...
        /* $("#ChandiLogo").attr('src', "/Content/images/site/logo/CHBH_LOGO_BLACK.png");*/
    ...
    $(".btnAddToCart").click(function (e) {
        ...
        $.ajax({
            ...
            data: {
                ...
                ID: $('input[name="flexRadioDefault"]:checked').val(),
                quantity: quantity
            }
        })
    ...
    $(".btnAddToWishList").click(function (e) {
        ...
        Toast.fire({
            icon: 'info',
            iconHtml: '<i class="spinner-border spinner-border-sm"></i>',
            title: RESOURCE_ADDINGTOWISHLIST
        });
            ...
            .done(function (response) {
                if (response.Success) {
                    ...
                    Swal.fire({
                        ...
                        text: response.Message,
                        /* footer: '<div class"btn btn-sm btn-success"><a style="color:blue" href="en/login">Login</a></div>'*/
                    })
...
function applyDarkMode() {
    if ($(".darkreader")[0]) {
        ...
        $("#ChandiLogo").attr('src', "/Content/images/site/logo/CHBH_LOGO_WHITE.png");
    }
}
