...
namespace eCommerce.Shared.Helpers
{
    public static class URLHelper
    {
        ...
        //public static string UserOrderDetails(this UrlHelper helper, object ID)
        //{
        //    string routeURL = string.Empty;
        ...
        //    if (ConfigurationsHelper.EnableMultilingual)
        //    {
        //        routeURL = helper.RouteUrl("LanguageBased_UserOrderDetails", routeValues);
        //    }
        //    else routeURL = helper.RouteUrl("UserOrderDetails", routeValues);

        //    routeURL = HttpUtility.UrlDecode(routeURL, System.Text.Encoding.UTF8);
        //    return routeURL.ToLower();
        //}
        public static string UserOrderDetails(this UrlHelper helper, string controller, object ID)
        {
            string routeURL = string.Empty;
            ...
            if (ConfigurationsHelper.EnableMultilingual)
            {
                routeURL = helper.RouteUrl("LanguageBased_EntityDetail", routeValues);
            }
            else routeURL = helper.RouteUrl("EntityDetail", routeValues);

            routeURL = HttpUtility.UrlDecode(routeURL, System.Text.Encoding.UTF8);
            return routeURL.ToLower();
        }

        //public static string UserOrderDetails(this UrlHelper helper)
        //{
        //    string routeURL = string.Empty;

        //    if (ConfigurationsHelper.EnableMultilingual)
        //    {
        //        routeURL = helper.RouteUrl("LanguageBased_UserOrderDetails");
        //    }
        //    else routeURL = helper.RouteUrl("UserOrderDetails");
        ...
        public static string UpdateUserAddress(this UrlHelper helper)
        {
            string routeURL = string.Empty;

            if (ConfigurationsHelper.EnableMultilingual)
            {
                routeURL = helper.RouteUrl("LanguageBased_UpdatesAddress");
            }
            else routeURL = helper.RouteUrl("UpdatesAddress");
        ...
        public static string RemoveItemFromWishList(this UrlHelper helper)
        {
            string routeURL = string.Empty;

            if (ConfigurationsHelper.EnableMultilingual)
            {
                routeURL = helper.RouteUrl("LanguageBased_RemoveItemFromWishList");
            }
            else routeURL = helper.RouteUrl("RemoveItemFromWishList");
        ...
        public static string WishList(this UrlHelper helper)
        {
            string routeURL = string.Empty;

            if (ConfigurationsHelper.EnableMultilingual)
            {
                routeURL = helper.RouteUrl("LanguageBased_WishList");
            }
            else routeURL = helper.RouteUrl("WishList");

            routeURL = HttpUtility.UrlDecode(routeURL, System.Text.Encoding.UTF8);
            return routeURL.ToLower();
        }
        public static string AddToWishList(this UrlHelper helper)
        {
            string routeURL = string.Empty;

            if (ConfigurationsHelper.EnableMultilingual)
            {
                routeURL = helper.RouteUrl("LanguageBased_AddToWishList");
            }
            else routeURL = helper.RouteUrl("AddToWishList");

            routeURL = HttpUtility.UrlDecode(routeURL, System.Text.Encoding.UTF8);
            return routeURL.ToLower();
        }
        
             public static string CancelRequest(this UrlHelper helper)
        {
            string routeURL = string.Empty;

            if (ConfigurationsHelper.EnableMultilingual)
            {
                routeURL = helper.RouteUrl("LanguageBased_CancelRequest");
            }
            else routeURL = helper.RouteUrl("CancelRequest");

            routeURL = HttpUtility.UrlDecode(routeURL, System.Text.Encoding.UTF8);
            return routeURL.ToLower();
        }
        public static string RETURNREQUEST(this UrlHelper helper)
        {
            string routeURL = string.Empty;

            if (ConfigurationsHelper.EnableMultilingual)
            {
                routeURL = helper.RouteUrl("LanguageBased_RETURNREQUEST");
            }
            else routeURL = helper.RouteUrl("RETURNREQUEST");
        ...
        public static string GetAddresscheckout(this UrlHelper helper)
        {
            string routeURL = string.Empty;

            if (ConfigurationsHelper.EnableMultilingual)
            {
                routeURL = helper.RouteUrl("LanguageBased_GetAddresscheckout");
            }
            else routeURL = helper.RouteUrl("GetAddresscheckout");
        ...
        public static string PlaceOrder(this UrlHelper helper, bool isCashOnDelivery = false, bool isRazorPay = false)
        {
            string routeURL = string.Empty;
            ...
            {
                routeURL = helper.RouteUrl(string.Format("{0}PlaceOrderViaRazorPay", LanguageBased));
            }
            else
            {
        ...
        public static string OrderPayment(this UrlHelper helper)
        {
            string routeURL = string.Empty;
            ...
            if (ConfigurationsHelper.EnableMultilingual)
            {
                routeURL = helper.RouteUrl("LanguageBased_OrderPayment", routeValues);
            }
            else routeURL = helper.RouteUrl("OrderPayment", routeValues);
        ...
        //public static string OrderLaterPayment(this UrlHelper helper, int OrderID)
        //{
        //    string routeURL = string.Empty;
        ...
        //    if (ConfigurationsHelper.EnableMultilingual)
        //    {
        //        routeURL = helper.RouteUrl("LanguageBased_PayforOrder", OrderID);
        //    }
        //    else routeURL = helper.RouteUrl("PayforOrder", OrderID);

        //    routeURL = HttpUtility.UrlDecode(routeURL, System.Text.Encoding.UTF8);
        //    return routeURL.ToLower();
        //}
        public static string OrderSuccess(this UrlHelper helper)
        {
            string routeURL = string.Empty;
            ...
            if (ConfigurationsHelper.EnableMultilingual)
            {
                routeURL = helper.RouteUrl("LanguageBased_OrderSuccess", routeValues);
            }
            else routeURL = helper.RouteUrl("OrderSuccess", routeValues);
        ...
        public static string EditUserAddress(this UrlHelper helper, string controller, object ID)
        {
            string routeURL = string.Empty;
        ...
        public static string UserAddress(this UrlHelper helper)
        {
            string routeURL = string.Empty;

            if (ConfigurationsHelper.EnableMultilingual)
            {
                routeURL = helper.RouteUrl("LanguageBased_UserAddress");
            }
            else routeURL = helper.RouteUrl("UserAddress");

            routeURL = HttpUtility.UrlDecode(routeURL, System.Text.Encoding.UTF8);
            return routeURL.ToLower();
        }

        public static string AddUserAddress(this UrlHelper helper)
        {
            string routeURL = string.Empty;

            if (ConfigurationsHelper.EnableMultilingual)
            {
                routeURL = helper.RouteUrl("LanguageBased_AddUserAddress");
            }
            else routeURL = helper.RouteUrl("AddUserAddress");

            routeURL = HttpUtility.UrlDecode(routeURL, System.Text.Encoding.UTF8);
            return routeURL.ToLower();
        }

        public static string UpdateAddress(this UrlHelper helper)
        {
            string routeURL = string.Empty;

            if (ConfigurationsHelper.EnableMultilingual)
            {
                routeURL = helper.RouteUrl("LanguageBased_UpdateAddress");
            }
            else routeURL = helper.RouteUrl("UpdateAddress");

            routeURL = HttpUtility.UrlDecode(routeURL, System.Text.Encoding.UTF8);
            return routeURL.ToLower();
        }
        public static string RemoveAddress(this UrlHelper helper)
        {
            string routeURL = string.Empty;

            if (ConfigurationsHelper.EnableMultilingual)
            {
                routeURL = helper.RouteUrl("LanguageBased_RemoveAddress");
            }
            else routeURL = helper.RouteUrl("RemoveAddress");
