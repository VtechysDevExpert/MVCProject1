...
#pragma warning disable CS0246 // The type or namespace name 'SixLabors' could not be found (are you missing a using directive or an assembly reference?)
using SixLabors.ImageSharp;
#pragma warning restore CS0246 // The type or namespace name 'SixLabors' could not be found (are you missing a using directive or an assembly reference?)
#pragma warning disable CS0246 // The type or namespace name 'SixLabors' could not be found (are you missing a using directive or an assembly reference?)
...
namespace eCommerce.Shared.Helpers
{
    ...
    {
#pragma warning disable CS0246 // The type or namespace name 'Picture' could not be found (are you missing a using directive or an assembly reference?)
...
#pragma warning restore CS0246 // The type or namespace name 'Picture' could not be found (are you missing a using directive or an assembly reference?)
        {
...
#pragma warning disable CS0246 // The type or namespace name 'Size' could not be found (are you missing a using directive or an assembly reference?)
#pragma warning disable CS0246 // The type or namespace name 'Size' could not be found (are you missing a using directive or an assembly reference?)
        private static Size CalculateDimensions(Size originalSize, int targetSize, bool ensureSizePositive = true)
#pragma warning restore CS0246 // The type or namespace name 'Size' could not be found (are you missing a using directive or an assembly reference?)
#pragma warning restore CS0246 // The type or namespace name 'Size' could not be found (are you missing a using directive or an assembly reference?)
        {
            float width, height;
...
#pragma warning disable CS0246 // The type or namespace name 'ProductPicture' could not be found (are you missing a using directive or an assembly reference?)
#pragma warning disable CS0246 // The type or namespace name 'Picture' could not be found (are you missing a using directive or an assembly reference?)
        public static Picture GetProductThumbnail(List<ProductPicture> productPictures, int thumbnailPictureID)
#pragma warning restore CS0246 // The type or namespace name 'Picture' could not be found (are you missing a using directive or an assembly reference?)
#pragma warning restore CS0246 // The type or namespace name 'ProductPicture' could not be found (are you missing a using directive or an assembly reference?)
        {
